...
const QString BITCOIN_IPC_PREFIX("easter:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click easter: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start easter: click-to-pay handler");
    else
...
{
    // clicking on easter: URLs creates FileOpen events on the Mac:
